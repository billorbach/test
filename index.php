...
<head>
  ...
  <script type="text/JavaScript" src="create_master.js"></script>
  <script type="text/JavaScript" src="edit_master.js"></script>
  <script type="text/JavaScript" src="revert_master.js"></script>
   <!--<script src="create_master.js" />-->
  <!--<?php include("create_master.js"); ?>-->
...
<div id="content">
  ...
  <div id="page">
	...
	<div id="master">
	<center>
	<img src="images/create_master.jpg"  height="100" width="100" onclick="javascript:create_master_next()" />
       	<img src="images/edit_master.jpg"  height="100" width="100" onclick="javascript:edit_master_next()" />
	<img src="images/revert_master.jpg"  height="100" width="100" onclick="javascript:revert_master_next()" />
        </center>
	</div>
	<!--<center>
	<img src="images/previous.png" onclick="javascript:previous()" />
	<img src="images/next.png" onclick="javascript:next()" />
	</center>-->

	<div id="step">
       
	</div>
	<!--<center><button type="button" onclick="javascript:step()">Step</button></center>-->

 	<!--<center><button type="button" onclick="loadXMLDoc()">Next</button></center>-->
