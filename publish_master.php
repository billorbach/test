...
<form action="write_data3.php" method="get">
...
<select name="network_interface">
  ...
  <option value="vmxnet2-enhanced">VMXNet2-Enhanced</option>
...
<select name="scsi_controller">
  ...
  <option value="lsilogic-parallel">Lsilogic Parallel</option>
  <option value="lsilogic-sas">Lsilogic SAS</option>
  <option value="vmware-paravirtual">VMWare Paravirtual</option>
</select>
</br>
</div>
<div align="left"><br>
